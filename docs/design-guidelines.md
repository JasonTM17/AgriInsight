...
The local Streamlit dashboard consumes the generated visual catalog under
`dashboard/assets/generated/` with contextual captions, a soft missing-file
fallback, and an explicit AI-generated demo-evidence boundary. The production-
shaped Next.js implementation covers nine permission-driven areas and passed
the real seven-persona hosted browser gate. Python, backend, web, and analytics
API images have verified Docker Hub/GHCR `0.2.3` evidence; production host,
OIDC operations, hostname/TLS, observability, and rollback approval remain
gated.
