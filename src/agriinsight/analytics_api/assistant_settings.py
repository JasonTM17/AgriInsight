...
class AssistantSettings:
    ...
    def from_environment(
        ...
        return cls(
            ...
            max_query_chars=_integer(
                source, "AGRIINSIGHT_ASSISTANT_MAX_QUERY_CHARS", 1_200
            ),
            max_history_turns=_integer(
                source, "AGRIINSIGHT_ASSISTANT_MAX_HISTORY_TURNS", 6
            ),
    ...
    def validated(self) -> AssistantSettings:
        ...
        _bounded_int(self.max_query_chars, "query characters", 100, 4_000)
        _bounded_int(self.max_history_turns, "history turns", 0, 12)
...
def _validated_base_url(value: str) -> str:
    ...
    if (
        ...
        raise AssistantSettingsError(
            "LLM base URL must be the fixed DeepSeek origin"
        )
