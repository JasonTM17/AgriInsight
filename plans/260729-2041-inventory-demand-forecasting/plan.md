...
| Phase | Name | Status |
|-------|------|--------|
| 1 | [Forecast contract and backtested baseline](./phase-01-forecast-contract-and-backtested-baseline.md) | In Progress |
| 2 | [Gold pipeline and decision integration](./phase-02-gold-pipeline-and-decision-integration.md) | Pending |
