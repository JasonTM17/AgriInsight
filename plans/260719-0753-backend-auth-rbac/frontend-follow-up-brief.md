...
Reviewed fixtures: [`design-system/prototypes/overview-field-ledger-prototype.html`](./design-system/prototypes/overview-field-ledger-prototype.html), [`design-system/prototypes/farm-performance-prototype.html`](./design-system/prototypes/farm-performance-prototype.html), the mobile-first [`design-system/prototypes/work-activity-prototype.html`](./design-system/prototypes/work-activity-prototype.html), and the Gold-backed read-only [`design-system/prototypes/cost-analysis-prototype.html`](./design-system/prototypes/cost-analysis-prototype.html); review evidence is stored beside each fixture, with Cost browser evidence under [`reports/cost-analysis-browser-gate/`](./reports/cost-analysis-browser-gate/). The Gold-backed [`design-system/prototypes/inventory-control-prototype.html`](./design-system/prototypes/inventory-control-prototype.html) is source-complete and static-verified but remains outside this reviewed list until its browser gate runs.
