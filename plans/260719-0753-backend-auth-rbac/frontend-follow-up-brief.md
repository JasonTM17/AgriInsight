...
Reviewed fixtures: [`design-system/prototypes/overview-field-ledger-prototype.html`](./design-system/prototypes/overview-field-ledger-prototype.html), [`design-system/prototypes/farm-performance-prototype.html`](./design-system/prototypes/farm-performance-prototype.html), the mobile-first [`design-system/prototypes/work-activity-prototype.html`](./design-system/prototypes/work-activity-prototype.html), the Gold-backed read-only [`design-system/prototypes/cost-analysis-prototype.html`](./design-system/prototypes/cost-analysis-prototype.html), and the WH-001-scoped [`design-system/prototypes/inventory-control-prototype.html`](./design-system/prototypes/inventory-control-prototype.html). Review evidence is stored beside each fixture, with browser evidence under [`reports/cost-analysis-browser-gate/`](./reports/cost-analysis-browser-gate/) and [`reports/inventory-control-browser-gate/`](./reports/inventory-control-browser-gate/).
