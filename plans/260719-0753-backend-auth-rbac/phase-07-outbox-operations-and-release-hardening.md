...
- Create: `D:\AgriInsight\backend\src\main\resources\db\migration\V16__create_outbox_tables.sql`
- Create: `D:\AgriInsight\backend\src\main\resources\db\migration\V17__add_outbox_rls_and_indexes.sql`
...
- Fresh and phase-6-upgrade role bootstrap -> Flyway V16-V17, plus backup -> clean-cluster role bootstrap -> ACL-preserving restore -> Flyway/RLS/grant/runtime smoke drill with checksum and measured restore time; no production claim without approved RPO/RTO/retention/off-host encryption.
