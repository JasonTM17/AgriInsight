...
public class MaterialRoutes implements SecuredRouteRegistry.Contributor {
    ...
    public Collection<SecuredRouteRegistry.Route> routes() {
        return List.of(
                permission(HttpMethod.GET, MATERIALS, Permission.INVENTORY_READ),
                permission(HttpMethod.POST, MATERIALS, Permission.INVENTORY_MANAGE),
                permission(HttpMethod.GET, MATERIALS + "/{id}", Permission.INVENTORY_READ),
                permission(HttpMethod.PATCH, MATERIALS + "/{id}", Permission.INVENTORY_MANAGE),
                permission(
                        HttpMethod.POST,
