...
public class WarehouseMutationController {

    private static final String WAREHOUSES = ApiVersion.PREFIX + "/warehouses";
    private static final String WAREHOUSE = WAREHOUSES + "/{id}";
    ...
    @PostMapping
    ResponseEntity<WarehouseResponse> create(
            @Valid @RequestBody WarehouseCreateRequest body,
            @RequestHeader("Idempotency-Key") String idempotencyKey,
            @AuthenticationPrincipal TenantPrincipal principal,
            HttpServletRequest request) {
        String correlationId = RequestCorrelation.resolve(request);
        var command = new WarehouseCommands.Create(
                body.code(),
                body.displayName(),
                Optional.ofNullable(body.locationText()),
        ...
        var execution = commands.create(
                fingerprints.create(
                        ...
                        CanonicalCommandBody.of(Map.of(
                                ...
                                "locationText", Optional.ofNullable(body.locationText()),
        ...
        return ResponseEntity.status(completed.responseStatus())
                ...
                .location(URI.create(WAREHOUSES + "/" + response.id()))
                .body(response);
    }
    ...
    ResponseEntity<WarehouseResponse> update(
            ...
            @Valid @RequestBody WarehouseUpdateRequest body,
            @RequestHeader("Idempotency-Key") String idempotencyKey,
        ...
        var command = new WarehouseCommands.Update(
                ...
                locationPatch(body.locationText(), body.clearLocationText()),
                expected.value(),
                audit(body.reasonCode(), correlationId));
    ...
    private String canonicalBody(WarehouseUpdateRequest body) {
        return CanonicalCommandBody.of(Map.of(
                "code", Optional.ofNullable(body.code()),
                "displayName", Optional.ofNullable(body.displayName()),
                "locationText", Optional.ofNullable(body.locationText()),
                "clearLocationText", body.clearLocationText(),
                "reasonCode", Optional.ofNullable(body.reasonCode())));
    }

    private Optional<Optional<String>> locationPatch(String value, boolean clear) {
